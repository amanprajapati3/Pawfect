...
const serviceDetailItems = sec.ServiceDetails.variants.PetServices1
  .services as ServiceDetailsItem[];

const teamDetailMembers = sec.TeamDetails.variants.PetTeamDetails1
  .members as PetTeamMemberDetail[];

const blogDetailPosts = sec.BlogDetails.variants.PetBlogDetails1
  .posts as PetBlogDetailPost[];

const serviceAreaDetailLocations = sec.ServiceAreaDetails.variants
  .PetServiceAreaDetails1.locations as PetServiceAreaDetail[];
