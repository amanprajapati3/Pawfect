  ...
  return (
    <section className="w-full overflow-hidden bg-[#F3E8FF] py-8 md:py-12">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
        {/* HEADER AREA */}
        <SectionHeader badge={badge} title={title} description={desc} className="mb-14" />
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-4 lg:gap-10">
            {members.map((member, index) => (
              <ScrollReveal
                ...
                className="h-full"
              >
                <div className="group flex h-full flex-col items-center rounded-[20px] bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] transition-transform duration-300 hover:shadow-[0_8px_40px_rgba(0,0,0,0.06)]">
                {/* Image */}
          ...
          <>
            ...
            <div className="hidden sm:grid sm:grid-cols-2 sm:gap-8 lg:grid-cols-4 lg:gap-10">
              {members.map((member, index) => (
                ...
                >
                <div
                  className="group flex h-full flex-col items-center rounded-[20px] bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.03)] transition-transform duration-300 hover:shadow-[0_8px_40px_rgba(0,0,0,0.06)]"
                >
                  {/* Image */}
                  <div className="relative mb-6 flex h-[160px] w-[160px] items-center justify-center rounded-full border border-[#3B1264]/10 p-1 transition-transform duration-300 group-hover:scale-105 lg:h-[175px] lg:w-[175px]">
                    <div className="relative h-full w-full overflow-hidden rounded-full">
